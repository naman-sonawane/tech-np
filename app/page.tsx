...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-3">
              <button
                onClick={() => scrollToSection("about")}
                className="text-left text-gray-800 hover:text-blue-400 font-thin transition-colors duration-300"
              >
                About
              </button>
              <button
      ...
      <section
        id="hero"
        className="min-h-screen flex items-center justify-center bg-gradient-to-br text-black relative overflow-hidden"
      >
        ...
        <div className="relative z-10 text-center max-w-4xl flex items-center justify-center flex-col mx-auto px-6">
          ...
          >
            A non-profit aiming to bridge the digital divide and unlock new
          ...
          <div className="flex flex-col md:flex-row items-start max-w-7xl gap-12 flex-grow">
            ...
            >
              ...
              <motion.p
                ...
                variants={textVariants}
              >
                At Tech 4 All, our mission is to bridge the digital divide by
                providing equitable access to technology, digital literacy, and
                opportunity for underserved communities. We believe that in
                today&apos;s world, access to technology isn&apos;t a
              ...
              <motion.p
                ...
                variants={textVariants}
              >
                Whether it&apos;s a student needing technology for school,
                healthcare, work, or for personal use, we&apos;re here to
                empower every individual with the tools they need to thrive.
                Through community partnerships, tech donations, and fundraising,
                we aim to create a more connected, inclusive, and empowered
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <motion.div className="text-center mb-16" variants={textVariants}>
            <h2 className="text-5xl font-bold pixelify text-blue-600 mb-6">
              How We Change Lives
            </h2>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                We collect unused or gently-used technology from offices,
                institutions, and community members. By giving this tech a
                second life, we help create new opportunities for those in need.
              </p>
              <div className="overflow-hidden bg-blue-100 bg-opacity-10 hover:bg-opacity-0 transition duration-300">
                <img
                  src="/sk_collection.png"
                  alt="Collection"
                  className="w-full object-cover"
                />
              </div>
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                We raise funds through community support and partnerships. These
                contributions allow us to purchase, repair, prepare, and
                distribute devices to those who need them most.
              </p>
              <div className="overflow-hidden bg-blue-400 bg-opacity-10 hover:bg-opacity-0 transition duration-300">
                <img
                  src="/sk_fundraising.png"
                  alt="Fundraising"
                  className="w-full bg-blue-300 object-cover"
                />
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                We assess, clean, and repair devices to ensure they&apos;re
                ready for use. We work with charities, local groups, and schools
                to reach under-resourced communities.
              </p>
              <div className="overflow-hidden bg-blue-100 bg-opacity-10 hover:bg-opacity-0 transition duration-300">
                <img
                  src="/sk_distribution.png"
                  alt="Distribution"
                  className="w-full object-cover"
                />
              </div>
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                After distribution, we stay in touch to offer ongoing support
                and help resolve any issues. We ensure the technology is working
                well and being used effectively.
              </p>
              <div className="overflow-hidden bg-blue-100 bg-opacity-10 hover:bg-opacity-0 transition duration-300">
                <img
                  src="/sk_followup.png"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <motion.div className="text-center group" variants={cardVariants}>
              ...
              <p className="text-gray-700 mb-6">
                Help us bridge the digital divide with your support. You can
                make a difference through monetary donations or by contributing
                gently used tech like laptops, tablets, or phones.
              </p>
              <motion.button
                onClick={() => scrollToSection("contact")}
            ...
            <motion.div className="text-center group" variants={cardVariants}>
              ...
              <p className="text-gray-700 mb-6">
                Be part of the hands-on impact! Volunteers help us gather,
                repair, and distribute donated tech to those in need. Whether
                you&apos;re tech-savvy or just passionate about helping others.
              </p>
              <motion.button
                onClick={() => scrollToSection("contact")}
            ...
            <motion.div className="text-center group" variants={cardVariants}>
              ...
              <p className="text-gray-700 mb-6">
                Not ready to donate or volunteer? You can still make a huge
                difference by spreading the word. Follow us on social media,
                share our mission, and help raise awareness.
              </p>
              <motion.button
                onClick={() => scrollToSection("contact")}
                className="bg-blue-600 text-white px-8 py-3 font-bold hover:bg-blue-800 transition-all duration-300"
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <motion.div className="text-center mb-16" variants={textVariants}>
            <h2 className="text-5xl font-bold pixelify mb-6">Get in Touch</h2>

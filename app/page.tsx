  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <nav className="max-w-md mx-auto p-2 flex justify-between shadow-lg items-center bg-black  backdrop-blur-md border-0 border-blue-400">
          ...
          <motion.button 
            ...
            className="relative text-gray-100 bluehover:text-blue-400 font-thin transition-colors duration-300 group"
            whileHover={{ scale: 1.05 }}
          >
            About
          ...
          <motion.button 
            ...
            className="relative text-gray-100 bluehover:text-blue-400 pr-4 font-thin transition-colors duration-300 group"
            whileHover={{ scale: 1.05 }}
          >
            Contact
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center bg-gradient-to-br text-black relative overflow-hidden">
        ...
        <motion.div 
          className="absolute inset-x-0 opacity-20 bottom-0"
